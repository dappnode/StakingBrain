...
import { Web3SignerApiClient } from "../apiClients/web3signerApiClient/index.js";
...
export class BrainDataBase extends LowSync<StakingBrainDb> {
   ...
   */
  public async initialize(signerApi: Web3SignerApiClient): Promise<void> {
    try {
