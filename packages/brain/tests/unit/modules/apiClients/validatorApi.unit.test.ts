    ...
    describe(`Consensus client: ${consensusClient.name}`, () => {
      ...
      it("Should set fee recipients to all validators", async () => {
        for (const pubkey of pubkeys)
          await validatorApi.setFeeRecipient(defaultFeeRecipient, pubkey);
      });
      ...
      it("Should delete fee recipients to all validators", async () => {
        for (const pubkey of pubkeys)
          await validatorApi.deleteFeeRecipient(pubkey);
      });
        ...
        const expectedResponse = [
          {
            status: "deleted",
            message:
              "Successfully deleted pubkey: 0xa2cc280ce811bb680cba309103e23dc3c9902f2a08541c6737e8adfe8198e796023b959fc8aadfad39499b56ec3dd184",
          },
          {
            status: "deleted",
            message:
              "Successfully deleted pubkey: 0x86d25af52627204ab822a20ac70da6767952841edbcb0b83c84a395205313661de5f7f76efa475a46f45fa89d95c1dd7",
          },
          {
            status: "deleted",
            message:
              "Successfully deleted pubkey: 0x821a80380122281580ba8a56cd21956933d43c62fdc8f5b4ec31b2c620e8534e80b6b816c9a2cc8d25568dc4ebcfd47a",
          },
          {
            status: "deleted",
            message:
              "Successfully deleted pubkey: 0x8f2b698583d69c7a78b4482871282602adb7fb47a1aab66c63feb48e7b9245dad77b82346e0201328d66a8b4d483b716",
          },
          {
            status: "deleted",
            message:
              "Successfully deleted pubkey: 0xa1735a0dd72205dae313c36d7d17f5b06685944c8886ddac530e5aedbe1fca0c8003e7e274ec1b4ddd08b884f5b9a830",
          },
        ];
        expect(response.data).to.eql(expectedResponse);
      });
